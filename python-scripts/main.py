...
if __name__ == "__main__":
    ...
    df_sent_bool = sentimetBoolean(df,0.95)

    # Likert scale model binnen halen
    from scripts.sentiment import sentimetLikert
    df_sent_likert = sentimetLikert(df)

    # data prepareren voor visualisatie
    from scripts.visualisze import sentimentVisDfBool,sentimentVisDfLikert
    ...
    # toon barplot
    from scripts.visualisze import sentimentBarPlotBool,sentimentBarPlotLikert
